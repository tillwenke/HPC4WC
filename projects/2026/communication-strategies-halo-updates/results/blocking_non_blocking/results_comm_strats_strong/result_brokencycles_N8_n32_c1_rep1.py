...
data = np.array( [ \
[   32, 1024, 1024,   64,    1024,  0.2413601E+01,  0.4458371E+00,  0.1639359E+01,  0.4185295E+00,  0.1600510E+01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy brokencycles"
...
slurm_jobid = "867084"
t_start = "2026-09-15T16:15:56+02:00"
wall_s = 988.779
t_start_approx = 0
