...
data = np.array( [ \
[   16, 1024, 1024,   64,    1024,  0.4479448E+01,  0.5783367E+00,  0.3333565E+01,  0.4996284E+00,  0.3231228E+01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy brokencycles"
...
slurm_jobid = "867068"
t_start = "2026-09-15T16:09:45+02:00"
wall_s = 67.687
t_start_approx = 0
