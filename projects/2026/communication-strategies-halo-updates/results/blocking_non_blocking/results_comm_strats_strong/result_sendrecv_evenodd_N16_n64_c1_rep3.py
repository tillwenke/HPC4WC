...
data = np.array( [ \
[   64, 1024, 1024,   64,    1024,  0.1358452E+01,  0.2521369E+00,  0.8935976E+00,  0.2290709E+00,  0.8688012E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 16 -n 64 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy sendrecv_evenodd"
...
slurm_jobid = "867238"
t_start = "2026-09-15T17:01:18+02:00"
wall_s = 25.644
t_start_approx = 0
