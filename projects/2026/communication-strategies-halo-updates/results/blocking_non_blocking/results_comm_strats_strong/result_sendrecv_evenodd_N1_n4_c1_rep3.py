...
data = np.array( [ \
[    4, 1024, 1024,   64,    1024,  0.2550438E+02,  0.1395633E+01,  0.1936381E+02,  0.1123392E+01,  0.1904688E+02], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 4 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy sendrecv_evenodd"
...
slurm_jobid = "867009"
t_start = "2026-09-15T16:00:02+02:00"
wall_s = 44.669
t_start_approx = 0
