...
data = np.array( [ \
[    8, 1024, 1024,   64,    1024,  0.1010166E+02,  0.7382535E+00,  0.7951782E+01,  0.6405574E+00,  0.7802869E+01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 2 -n 8 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy brokencycles"
...
slurm_jobid = "867062"
t_start = "2026-09-15T16:07:31+02:00"
wall_s = 32.829
t_start_approx = 0
