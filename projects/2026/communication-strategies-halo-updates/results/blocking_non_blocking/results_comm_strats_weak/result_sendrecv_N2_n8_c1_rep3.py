...
data = np.array( [ \
[    8,  256,  512,   64,    1024,  0.1295173E+01,  0.1788152E+00,  0.8806949E+00,  0.1624819E+00,  0.8723560E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 2 -n 8 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 256 --ny 512 --nz 64 --num_iter 1024 --comm_strategy sendrecv"
...
slurm_jobid = "866623"
t_start = "2026-09-15T14:56:32+02:00"
wall_s = 14.442
t_start_approx = 0
