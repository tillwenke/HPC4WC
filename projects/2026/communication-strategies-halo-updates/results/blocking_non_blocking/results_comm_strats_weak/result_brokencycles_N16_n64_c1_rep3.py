...
data = np.array( [ \
[   64, 1024, 1024,   64,    1024,  0.1571053E+01,  0.4702041E+00,  0.9058351E+00,  0.4355758E+00,  0.8736833E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 16 -n 64 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy brokencycles"
...
slurm_jobid = "866726"
t_start = "2026-09-15T15:13:30+02:00"
wall_s = 23.541
t_start_approx = 0
