...
data = np.array( [ \
[    8,  256,  512,   64,    1024,  0.1341277E+01,  0.2228523E+00,  0.8963946E+00,  0.1983454E+00,  0.8811445E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 2 -n 8 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 256 --ny 512 --nz 64 --num_iter 1024 --comm_strategy sendrecv_evenodd"
...
slurm_jobid = "866620"
t_start = "2026-09-15T14:56:18+02:00"
wall_s = 14.117
t_start_approx = 0
