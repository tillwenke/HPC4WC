...
data = np.array( [ \
[   32,  512, 1024,   64,    1024,  0.1293197E+01,  0.2084899E+00,  0.8962242E+00,  0.1602667E+00,  0.8709267E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 512 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy irecvisend"
...
slurm_jobid = "866659"
t_start = "2026-09-15T15:05:36+02:00"
wall_s = 21.231
t_start_approx = 0
