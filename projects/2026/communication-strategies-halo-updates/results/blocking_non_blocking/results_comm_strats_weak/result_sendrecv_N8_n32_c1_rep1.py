...
data = np.array( [ \
[   32,  512, 1024,   64,    1024,  0.1317931E+01,  0.2050123E+00,  0.8926742E+00,  0.1825818E+00,  0.8733284E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 512 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy sendrecv"
...
slurm_jobid = "866657"
t_start = "2026-09-15T15:05:13+02:00"
wall_s = 23.550
t_start_approx = 0
