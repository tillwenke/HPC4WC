...
data = np.array( [ \
[    4,  256,  256,   64,    1024,  0.1309068E+01,  0.2010307E+00,  0.8872552E+00,  0.1784628E+00,  0.8708245E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 4 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 256 --ny 256 --nz 64 --num_iter 1024 --comm_strategy brokencycles"
...
slurm_jobid = "866594"
t_start = "2026-09-15T14:50:28+02:00"
wall_s = 30.146
t_start_approx = 0
