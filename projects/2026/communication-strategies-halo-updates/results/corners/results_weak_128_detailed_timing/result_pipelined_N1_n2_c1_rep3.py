...
data = np.array( [ \
[    2,  128,  256,   64,    1024,  0.1278221E+01,  0.1621687E+00,  0.1132968E+01,  0.1535272E+00,  0.1124505E+01,  0.8920222E-01,  0.3123629E-01,  0.3248342E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 2 -c 1 --ntasks-per-node=2 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi-corners-pipelined.x --nx 128 --ny 256 --nz 64 --num_iter 1024"
...
slurm_jobid = "836821"
t_start = "2026-08-31T11:47:34+02:00"
wall_s = 29.397
t_start_approx = 0
