...
data = np.array( [ \
[   96, 1024, 1536,   64,    1024,  0.1351136E+01,  0.2658271E+00,  0.1158466E+01,  0.2232086E+00,  0.1127796E+01,  0.1120204E+00,  0.1937646E-01,  0.9172191E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 24 -n 96 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi-corners-pipelined.x --nx 1024 --ny 1536 --nz 64 --num_iter 1024"
...
slurm_jobid = "837478"
t_start = "2026-08-31T14:07:53+02:00"
wall_s = 21.769
t_start_approx = 0
