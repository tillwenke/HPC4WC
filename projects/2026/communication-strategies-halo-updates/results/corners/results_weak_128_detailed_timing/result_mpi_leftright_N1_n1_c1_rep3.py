...
data = np.array( [ \
[    1,  128,  128,   64,    1024,  0.1292126E+01,  0.8677663E-01,  0.1205167E+01,  0.8677663E-01,  0.1205167E+01,  0.7785060E-01,  0.7873140E-02,  0.4893850E-03], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 1 -c 1 --ntasks-per-node=1 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi.x --nx 128 --ny 128 --nz 64 --num_iter 1024"
...
slurm_jobid = "836723"
t_start = "2026-08-31T11:34:32+02:00"
wall_s = 29.168
t_start_approx = 0
