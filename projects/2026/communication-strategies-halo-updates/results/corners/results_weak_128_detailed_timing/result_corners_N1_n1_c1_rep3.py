...
data = np.array( [ \
[    1,  128,  128,   64,    1024,  0.1210890E+01,  0.8983746E-01,  0.1120868E+01,  0.8983746E-01,  0.1120868E+01,  0.7877993E-01,  0.1011939E-01,  0.5073140E-03], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 1 -c 1 --ntasks-per-node=1 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi-corners.x --nx 128 --ny 128 --nz 64 --num_iter 1024"
...
slurm_jobid = "836806"
t_start = "2026-08-31T11:42:35+02:00"
wall_s = 26.896
t_start_approx = 0
