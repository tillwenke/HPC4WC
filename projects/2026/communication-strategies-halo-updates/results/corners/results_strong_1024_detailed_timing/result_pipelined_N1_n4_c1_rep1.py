...
data = np.array( [ \
[    4, 1024, 1024,   64,    1024,  0.2490287E+02,  0.1301602E+01,  0.2422777E+02,  0.9703067E+00,  0.2393193E+02,  0.5084630E+00,  0.9693067E-01,  0.3644530E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 4 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-pipelined.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837278"
t_start = "2026-08-31T13:20:02+02:00"
wall_s = 40.633
t_start_approx = 0
