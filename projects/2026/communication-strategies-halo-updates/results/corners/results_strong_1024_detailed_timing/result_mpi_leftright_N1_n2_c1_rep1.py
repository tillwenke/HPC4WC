...
data = np.array( [ \
[    2, 1024, 1024,   64,    1024,  0.4420213E+02,  0.1168668E+01,  0.4313073E+02,  0.1119457E+01,  0.4308179E+02,  0.7163938E+00,  0.1319136E-01,  0.3891845E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 2 -c 1 --ntasks-per-node=2 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837252"
t_start = "2026-08-31T13:12:09+02:00"
wall_s = 58.699
t_start_approx = 0
