...
data = np.array( [ \
[   64, 1024, 1024,   64,    1024,  0.1327294E+01,  0.2395098E+00,  0.1164152E+01,  0.1967994E+00,  0.1130365E+01,  0.1131194E+00,  0.9470420E-02,  0.7389926E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 16 -n 64 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837163"
t_start = "2026-08-31T12:45:51+02:00"
wall_s = 27.824
t_start_approx = 0
