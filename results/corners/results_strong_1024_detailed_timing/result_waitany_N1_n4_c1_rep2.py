...
data = np.array( [ \
[    4, 1024, 1024,   64,    1024,  0.2485362E+02,  0.8822325E+00,  0.2414140E+02,  0.7929072E+00,  0.2405968E+02,  0.5152461E+00,  0.2041079E-01,  0.2556763E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 4 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-waitany.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837282"
t_start = "2026-08-31T13:22:47+02:00"
wall_s = 42.110
t_start_approx = 0
