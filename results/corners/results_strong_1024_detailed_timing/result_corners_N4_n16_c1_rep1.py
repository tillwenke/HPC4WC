...
data = np.array( [ \
[   16, 1024, 1024,   64,    1024,  0.4528170E+01,  0.6933430E+00,  0.4230986E+01,  0.5345301E+00,  0.3993493E+01,  0.2115786E+00,  0.1205121E-01,  0.3108040E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837250"
t_start = "2026-08-31T13:11:43+02:00"
wall_s = 21.965
t_start_approx = 0
