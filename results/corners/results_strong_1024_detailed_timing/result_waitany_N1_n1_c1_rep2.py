...
data = np.array( [ \
[    1, 1024, 1024,   64,    1024,  0.9369266E+02,  0.1352034E+01,  0.9233985E+02,  0.1352034E+01,  0.9233985E+02,  0.1250637E+01,  0.9626223E-01,  0.3727730E-02], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 1 -c 1 --ntasks-per-node=1 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-waitany.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837363"
t_start = "2026-08-31T13:41:46+02:00"
wall_s = 108.864
t_start_approx = 0
