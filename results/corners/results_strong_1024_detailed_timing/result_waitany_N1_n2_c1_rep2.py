...
data = np.array( [ \
[    2, 1024, 1024,   64,    1024,  0.4424843E+02,  0.1171652E+01,  0.4327089E+02,  0.1074478E+01,  0.4317315E+02,  0.7190227E+00,  0.1659579E-01,  0.3373525E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 2 -c 1 --ntasks-per-node=2 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-waitany.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837292"
t_start = "2026-08-31T13:30:40+02:00"
wall_s = 61.440
t_start_approx = 0
