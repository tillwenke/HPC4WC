...
data = np.array( [ \
[   32, 1024, 1024,   64,    1024,  0.2216952E+01,  0.2825098E+00,  0.2011213E+01,  0.2363702E+00,  0.1980434E+01,  0.1376852E+00,  0.1058302E-01,  0.8661192E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-waitany.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837239"
t_start = "2026-08-31T13:09:22+02:00"
wall_s = 19.207
t_start_approx = 0
