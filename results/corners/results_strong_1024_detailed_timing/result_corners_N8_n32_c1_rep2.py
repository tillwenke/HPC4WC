...
data = np.array( [ \
[   32, 1024, 1024,   64,    1024,  0.2227513E+01,  0.2892130E+00,  0.2031638E+01,  0.2503735E+00,  0.1977003E+01,  0.1313757E+00,  0.1035072E-01,  0.1083250E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837241"
t_start = "2026-08-31T13:09:41+02:00"
wall_s = 19.047
t_start_approx = 0
