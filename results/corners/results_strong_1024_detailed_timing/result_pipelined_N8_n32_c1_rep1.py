...
data = np.array( [ \
[   32, 1024, 1024,   64,    1024,  0.2217801E+01,  0.2954915E+00,  0.2031628E+01,  0.2395416E+00,  0.1978104E+01,  0.1259146E+00,  0.2236995E-01,  0.9077272E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-pipelined.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837237"
t_start = "2026-08-31T13:09:01+02:00"
wall_s = 20.371
t_start_approx = 0
