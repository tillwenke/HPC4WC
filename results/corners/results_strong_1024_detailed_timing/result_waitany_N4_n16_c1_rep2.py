...
data = np.array( [ \
[   16, 1024, 1024,   64,    1024,  0.4359006E+01,  0.5302770E+00,  0.4059366E+01,  0.4077581E+00,  0.3951095E+01,  0.2238832E+00,  0.1214378E-01,  0.1703784E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-mpi-corners-waitany.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837258"
t_start = "2026-08-31T13:13:36+02:00"
wall_s = 22.186
t_start_approx = 0
