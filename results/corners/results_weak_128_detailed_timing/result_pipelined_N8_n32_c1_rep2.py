...
data = np.array( [ \
[   32,  512, 1024,   64,    1024,  0.1361669E+01,  0.2799951E+00,  0.1152783E+01,  0.2358986E+00,  0.1125639E+01,  0.1211989E+00,  0.2167865E-01,  0.9256911E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 8 -n 32 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi-corners-pipelined.x --nx 512 --ny 1024 --nz 64 --num_iter 1024"
...
slurm_jobid = "837137"
t_start = "2026-08-31T12:34:15+02:00"
wall_s = 29.971
t_start_approx = 0
