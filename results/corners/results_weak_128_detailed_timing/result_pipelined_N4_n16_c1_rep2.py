...
data = np.array( [ \
[   16,  512,  512,   64,    1024,  0.1326234E+01,  0.2277627E+00,  0.1165124E+01,  0.1891362E+00,  0.1136967E+01,  0.1188961E+00,  0.2231557E-01,  0.4744934E-01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-mpi-corners-pipelined.x --nx 512 --ny 512 --nz 64 --num_iter 1024"
...
slurm_jobid = "837123"
t_start = "2026-08-31T12:29:41+02:00"
wall_s = 30.153
t_start_approx = 0
