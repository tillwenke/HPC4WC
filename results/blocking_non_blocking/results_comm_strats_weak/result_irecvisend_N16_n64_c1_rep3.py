...
data = np.array( [ \
[   64, 1024, 1024,   64,    1024,  0.1311439E+01,  0.2152691E+00,  0.8969590E+00,  0.1790395E+00,  0.8710550E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 16 -n 64 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy irecvisend"
...
slurm_jobid = "866730"
t_start = "2026-09-15T15:14:39+02:00"
wall_s = 23.142
t_start_approx = 0
