...
data = np.array( [ \
[   16,  512,  512,   64,    1024,  0.1311557E+01,  0.2021199E+00,  0.8948797E+00,  0.1816421E+00,  0.8692977E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 10 ./stencil2d-comm_strats_timer.x --nx 512 --ny 512 --nz 64 --num_iter 1024 --comm_strategy sendrecv"
...
slurm_jobid = "866629"
t_start = "2026-09-15T14:57:41+02:00"
wall_s = 20.117
t_start_approx = 0
