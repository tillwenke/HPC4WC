...
data = np.array( [ \
[    8, 1024, 1024,   64,    1024,  0.9949431E+01,  0.5899731E+00,  0.7937206E+01,  0.4703648E+00,  0.7819332E+01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 2 -n 8 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy sendrecv"
...
slurm_jobid = "867065"
t_start = "2026-09-15T16:08:37+02:00"
wall_s = 33.502
t_start_approx = 0
