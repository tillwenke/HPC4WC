...
data = np.array( [ \
[   64, 1024, 1024,   64,    1024,  0.1321994E+01,  0.2221724E+00,  0.8997582E+00,  0.1903200E+00,  0.8703257E+00], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 16 -n 64 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy sendrecv"
...
slurm_jobid = "867233"
t_start = "2026-09-15T16:59:58+02:00"
wall_s = 26.571
t_start_approx = 0
