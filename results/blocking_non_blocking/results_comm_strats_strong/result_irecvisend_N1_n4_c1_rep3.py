...
data = np.array( [ \
[    4, 1024, 1024,   64,    1024,  0.2528124E+02,  0.1271800E+01,  0.1932494E+02,  0.8973232E+00,  0.1906863E+02], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 1 -n 4 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy irecvisend"
...
slurm_jobid = "867045"
t_start = "2026-09-15T16:01:31+02:00"
wall_s = 44.336
t_start_approx = 0
