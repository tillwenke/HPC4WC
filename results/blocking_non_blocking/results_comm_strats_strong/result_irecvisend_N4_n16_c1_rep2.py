...
data = np.array( [ \
[   16, 1024, 1024,   64,    1024,  0.4277234E+01,  0.3757216E+00,  0.3296327E+01,  0.2954286E+00,  0.3232131E+01], \
] )
...
command = "env OMP_NUM_THREADS=1 srun -A hpc4wc-course2026-ethz --uenv=prgenv-gnu/26.3:v1 --view=default -N 4 -n 16 -c 1 --ntasks-per-node=4 --gpus-per-task=1 --cpu-bind=cores -t 15 ./stencil2d-comm_strats_timer.x --nx 1024 --ny 1024 --nz 64 --num_iter 1024 --comm_strategy irecvisend"
...
slurm_jobid = "867079"
t_start = "2026-09-15T16:13:39+02:00"
wall_s = 26.913
t_start_approx = 0
